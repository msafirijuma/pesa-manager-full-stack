<div class="container mt-1">
    ...
    <table class="table table-width table-hover table-striped bg-light caption-top my-2 mt-3">
        <caption class="top text-dark display-6 text-center">Revenues Report Form (Annually)</caption>
        ...
        <tbody>
            ...
            $sqlYear = "SELECT * FROM revenues INNER JOIN registration ON revenues.user_id = registration.user_id WHERE revenues.user_id = '$activeUser' AND revenues.date_created BETWEEN DATE_SUB( CURDATE(), INTERVAL 12 MONTH) AND CURDATE()";
            ...
            <tr>
                ...
                <td><?php echo $rowYear["revenue_description"]; ?></td>
                <td colspan="2" class="not-print d-flex">
                    <a href="view-revenue.php?view_revenue=<?php echo $rowYear["revenue_id"]; ?>" title="View Revenue"
                        class="d-flex mx-1 btn btn-info text-light">
                        <i class="fas fa-eye me-1"></i><span class="action-btn">View</span></a>
                    <a href="edit-revenue.php?edit_revenue=<?php echo $rowYear["revenue_id"]; ?>"
                    ...
                    <a href="revenues.php?delete_revenue=<?php echo $rowYear["revenue_id"]; ?>"
            ...
            <div class="alert alert-info">
                <span>No record for this year.</span>
